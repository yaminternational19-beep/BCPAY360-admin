...
const DocumentModal = ({
  ...
  const handleSubmit = () => {
    if (!formData.formName || !formData.formCode || !formData.category) {
      toast.error("Document Name, Code, and Category are mandatory");
      return;
    }
    onSave(formData);
  };
      ...
      <div className="gf-modal" onClick={e => e.stopPropagation()}>
        <div className="gf-modal-header">
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <h3>{editData ? "Edit Configuration" : "Setup Document"}</h3>
          </div>
        ...
        <div className="gf-modal-body">
          <div className="gf-form-group">
            ...
            <input name="formCode" placeholder="e.g. DOC-12A" value={formData.formCode} onChange={handleChange} />
          </div>
          <div className="gf-form-group">
